...
const PROPERTY_TYPES = [
    { urlPath: 'properties-for-sale', totalRecords: 185, recordsPerPage: 12, isRental: false, label: 'SALE' },
    { urlPath: 'properties-to-rent', totalRecords: 36, recordsPerPage: 12, isRental: true, label: 'RENTAL' }
];
