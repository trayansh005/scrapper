...
const PROPERTY_TYPES = [
    { urlPath: 'properties/sales/status-available/most-recent-first', totalRecords: 388, recordsPerPage: 10, isRental: false, label: 'SALES' },
    { urlPath: 'properties/lettings/status-available/most-recent-first', totalRecords: 7, recordsPerPage: 10, isRental: true, label: 'LETTINGS' }
];
