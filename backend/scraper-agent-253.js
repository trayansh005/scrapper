// Agent 253 scraper using PlaywrightCrawler with Crawlee (Meyers Estates)
// Agent ID: 253
// Usage:
// node backend/scraper-agent-253.js [startPage]
        ...
        browserPoolOptions: {
            ...
            preLaunchHooks: [
                async (pageId, launchContext) => {
                    launchContext.launcher = require('playwright').chromium.connect;
...
async function scrapeAgent253() {
    logger.step("Starting Agent 253 scraper...");
    ...
    logger.step(
        `Completed Agent 253 - Total scraped: ${counts.totalScraped}, Total saved: ${counts.totalSaved}`,
    );
